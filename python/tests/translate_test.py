...
class xml_test(unittest.TestCase):
    ...
    def testExtractWikis(self):
        """Extract Wikis ID"""
        xml=b'<faq><t id="45">Blah1</t><b><t id="49">Blah2</t><t id="50">bla4<i>Blah5</i>bla6</t></b></faq>'
        extracted=atpic.translate.extract_id(xml)
        extracted_ok={b'45':b"Blah1",b'49':b"Blah2",b'50':b'bla4<i>Blah5</i>bla6'}
        # print extracted
        # print extracted_ok
    ...
    def NOtestExtractWikisDeep(self):
        """Extract Wikis ID"""
    ...
    def NOtestReplaceIdWikiOn(self):
    ...
    def NOtestReplaceIdWikiOffUnicode(self):
    ...
    def NOtestReplaceIdWikiOff(self):
        xml=b'<faq>META<t id="49">Nice<a href="/home">Home</a>expensive</t>river<t id="88">Thames</t>ppp</faq>'
        dictids={}
        dictids[b'49']=b'Belle<a href="/home">Maison</a>chere'
        dictids[b'88']=b'Tamise'
    ...
    def NOtestReplaceIdWikiOffMissingKey(self):
        xml=b'<faq>META<t id="49">Nice<a href="/home">Home</a>expensive</t>river<t id="88">Thames</t>ppp</faq>'
        dictids={}
        dictids[b'49']=b'Belle<a href="/home">Maison</a>chere'
        # Missing key test
